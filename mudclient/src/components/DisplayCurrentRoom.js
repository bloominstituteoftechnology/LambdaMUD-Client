...
console.log('testgameprogress', test)
    ...
    render() {
        ...
        gameprogress = <p className ='display-player-text'>Current Area: <span className='display-current-room-title'>{this.props.currentRoom.title}. </span><span className='display-current-room-description'>{this.props.currentRoom.description}</span></p>
        } else {
        ...
        gameprogress = <p className ='display-player-text'>Current Area: <span className='display-current-room-title'>{sessionStorageRoomTitle}. </span><span className='display-current-room-description'>{sessionStorageRoomDesc}</span></p>
        }
        return (
